    ...
    def _seed_defaults(self) -> None:
        defaults = [
            RoutingRule(rule_id="ceo_opus", name="CEO → Opus",
                        description="Route CEO agent to Opus for highest capability",
            ...
            RoutingRule(rule_id="guardian_opus", name="Guardian → Opus",
                        description="Route Guardian agent to Opus for safety reviews",
            ...
            RoutingRule(rule_id="war_room_opus", name="War Room → Opus",
                        description="Route strategic agents to Opus for depth",
            ...
            RoutingRule(rule_id="financial_sonnet", name="Finance → Sonnet",
                        description="Route finance mode tasks to Sonnet",
            ...
            RoutingRule(rule_id="offline_haiku", name="Offline → Haiku",
                        description="Route offline/survival mode to Haiku to minimise cost",
            ...
            RoutingRule(rule_id="high_complexity_opus", name="High complexity → Opus",
                        description="Route high-complexity tasks to Opus",
            ...
            RoutingRule(rule_id="low_complexity_haiku", name="Low complexity → Haiku",
                        description="Route low-complexity tasks to Haiku for cost savings",
            ...
            RoutingRule(rule_id="execute_sonnet", name="EXECUTE → Sonnet minimum",
                        description="Ensure EXECUTE-class actions use at least Sonnet",
