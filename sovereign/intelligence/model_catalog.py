...
_CATALOG: list[ModelEntry] = [
    ...
    ModelEntry(
        ...
        provider_type=ProviderType.CLOUD,
        tier=ModelTier.FRONTIER,
        reasoning_strength=0.88, coding_strength=0.87, creativity=0.84,
        instruction_following=0.92,
        cost_per_1k_input_usd=0.00825, cost_per_1k_output_usd=0.00825,
        avg_latency_ms=2000, context_window_tokens=128_000,
        multimodal=False, streaming=True,
        recommended_for=["kimi-fallback", "long-context", "chinese-language"],
        notes="Moonshot AI flagship. Excels at long-context and Chinese-language tasks.",
    ),
    ModelEntry(
        ...
        provider_type=ProviderType.CLOUD,
        tier=ModelTier.BALANCED,
        reasoning_strength=0.84, coding_strength=0.83, creativity=0.80,
        instruction_following=0.90,
        cost_per_1k_input_usd=0.00330, cost_per_1k_output_usd=0.00330,
        avg_latency_ms=1500, context_window_tokens=32_000,
        streaming=True,
        recommended_for=["kimi-balanced", "cost-effective"],
        notes="Balanced Kimi model. Good cost/quality for general tasks.",
    ),
    ModelEntry(
        ...
        provider_type=ProviderType.CLOUD,
        tier=ModelTier.FAST,
        reasoning_strength=0.80, coding_strength=0.79, creativity=0.76,
        instruction_following=0.87,
        cost_per_1k_input_usd=0.00165, cost_per_1k_output_usd=0.00165,
        avg_latency_ms=800, context_window_tokens=8_000,
        streaming=True,
        recommended_for=["kimi-fast", "budget"],
        notes="Fastest and cheapest Kimi model.",
    ),
